...
export const BUSINESSES: Business[] = [
  {
    ...
    name: "Brancho Water",
    parent: "Brancho",
    tagline: "Pure packaged drinking water, delivered.",
    description:
      "FSSAI-certified packaged drinking water in sealed jars and bottles for homes, societies and businesses across Gujarat. Product only — no services.",
    hero: "Pure packaged drinking water. Nothing else.",
    overview: [
      "Brancho Water is the packaged drinking water business of Brancho. We produce and deliver sealed, lab-tested packaged drinking water — jars and bottles — sourced, purified, packed and delivered under strict quality control.",
      "Brancho Water does not provide any services. No RO servicing, no tank cleaning, no water testing, no installation or maintenance — only pure packaged drinking water, delivered to your doorstep on a fixed schedule.",
    ],
    mission: "To make every Indian home confident about the packaged water it drinks.",
    services: [
      { title: "20L Drinking Water Jar", description: "Sealed 20-litre family jar for homes — delivered on subscription with return-and-refill jar exchange." },
      { title: "1L Water Bottles", description: "Sealed 1-litre packaged drinking water bottles in cases for homes, offices and travel." },
      { title: "500ml Water Bottles", description: "Sealed 500ml packaged drinking water bottles in cases for events, offices and daily use." },
      { title: "Society Subscriptions", description: "Fixed weekly packaged drinking water delivery schedule for apartments and housing societies." },
      { title: "Corporate & Bulk Supply", description: "Bulk packaged drinking water supply for offices, shops, restaurants, schools and events." },
      { title: "Event Water Packs", description: "Bulk bottle packs for weddings, functions and gatherings with scheduled doorstep delivery." },
    ],
    highlights: ["FSSAI-certified plant", "Sealed & tamper-proof packs", "Lab-tested every batch", "Fixed delivery schedule", "Jar return & refill system", "Bulk & society supply"],
    gallery: ["/about.svg", "/hero-poster.svg", "/about.svg", "/hero-poster.svg"],
    faqs: [
      { q: "Does Brancho Water provide RO service or tank cleaning?", a: "No. Brancho Water sells only packaged drinking water — sealed jars and bottles. We do not provide RO servicing, tank cleaning, water testing, installation or any other service." },
      { q: "What pack sizes are available?", a: "We offer 20-litre family jars, 1-litre bottles and 500ml bottles. Jars work on a return-and-refill exchange; bottles are supplied in sealed cases." },
    ],
    cta: "Order packaged water",
    ctaHref: "/contact",
  },
  {
    slug: "home-care",
